                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 text-center text-lg-start">
                          <h2 class="text-white mb-4 animated zoomIn">Welcome To My-Banking</h>
                            <h1 class="text-white mb-4 animated zoomIn">Safe,secure And Convenient Banking</h1>
		...
		<table id="account" class="table table-striped">
			...
			<c:if test="${fn:contains(user.role,'admin') }">
				...
				<c:forEach var="account" items="${accountList }">
					...
					<c:url var="depositLink" value="account">
					<c:param name="mode" value="LOAD_DEPOSIT"></c:param>
					<c:param name="id" value="${acc.id }"></c:param>
				</c:url>
				<c:url var="withdrawnLink" value="account">
					<c:param name="mode" value="LOAD_WITHDRAWN"></c:param>
					<c:param name="id" value="${acc.id }"></c:param>
					</c:url>
					<tr>
						<td> <c:out value="${acc.accountno }"></c:out> </td>
						<td> <c:out value="${acc.name }"></c:out> </td>
						<td> <c:out value="${acc.amount }"></c:out> </td>
						<td> <c:out value="${acc.address }"></c:out> </td>
						<td> <c:out value="${acc.phno }"></c:out> </td>
						<td> <a href="${depositLink }" class="btn btn-primary">Deposit</a></td>
						<td> <a href="${withdrawnLink }" class="btn btn-primary">Witdrawn</a></td>
					</tr>
